...
class DynamicGlobalProperties {
  ...
  DynamicGlobalProperties(Map<String, dynamic> value)
      : this.id = value['id'],
        this.head_block_number = value['result']['head_block_number'],
        this.head_block_id = value['result']['head_block_id'],
        this.time = value['result']['time'],
        this.current_witness = value['result']['current_witness'],
        this.total_pow = value['result']['total_pow'],
        this.num_pow_witnesses = value['result']['num_pow_witnesses'],
        this.virtual_supply = value['result']['virtual_supply'],
        this.current_supply = value['result']['current_supply'],
        this.confidential_supply = value['result']['confidential_supply'],
        this.init_sbd_supply = value['init_sbd_supply'],
        this.current_sbd_supply = value['result']['current_sbd_supply'],
        this.confidential_sbd_supply =
            value['result']['confidential_sbd_supply'],
        this.total_vesting_fund_steem =
            value['result']['total_vesting_fund_steem'],
        this.total_vesting_shares = value['result']['total_vesting_shares'],
        this.total_reward_fund_steem =
            value['result']['total_reward_fund_steem'],
        this.total_reward_shares2 = value['result']['total_reward_shares2'],
        this.pending_rewarded_vesting_shares =
            value['result']['pending_rewarded_vesting_shares'],
        this.pending_rewarded_vesting_steem =
            value['result']['pending_rewarded_vesting_steem'],
        this.sbd_interest_rate = value['result']['sbd_interest_rate'],
        this.sbd_print_rate = value['result']['sbd_print_rate'],
        this.average_block_size = value['result']['average_block_size'],
        this.maximum_block_size = value['result']['maximum_block_size'],
        this.required_actions_partition_percent =
            value['result']['required_actions_partition_percent'],
        this.current_aslot = value['result']['current_aslot'],
        this.recent_slots_filled = value['result']['recent_slots_filled'],
        this.participation_count = value['result']['participation_count'],
        this.last_irreversible_block_num =
            value['result']['last_irreversible_block_num'],
        this.max_virtual_bandwidth = value['result']['max_virtual_bandwidth'],
        this.current_reserve_ratio = value['result']['current_reserve_ratio'],
        this.vote_power_reserve_rate =
            value['result']['vote_power_reserve_rate'],
        this.delegation_return_period =
            value['result']['delegation_return_period'],
        this.reverse_auction_seconds =
            value['result']['reverse_auction_seconds'],
        this.available_account_subsidies =
            value['result']['available_account_subsidies'],
        this.sbd_stop_percent = value['result']['sbd_stop_percent'],
        this.sbd_start_percent = value['result']['sbd_start_percent'],
        this.next_maintenance_time = value['result']['next_maintenance_time'],
        this.last_budget_time = value['result']['last_budget_time'],
        this.content_reward_percent = value['result']['content_reward_percent'],
        this.vesting_reward_percent = value['result']['vesting_reward_percent'],
        this.sps_fund_percent = value['result']['sps_fund_percent'],
        this.sps_interval_ledger = value['result']['sps_interval_ledger'],
        this.downvote_pool_percent = value['result']['downvote_pool_percent'];
}
